...
const loadApplyingInfo = (_openid) => {
    return new Promise((resolve, reject) => {
       let map = {
        ...
        db.select(collection_ing, map,1).then(res => {
            resolve(res);
        }).catch((code, msg) => {
            reject("服务器开小差啦");
        });
...
const loadAppliedInfo = (_openid) => {
   return new Promise((resolve, reject) => {
      let map = {
       ...
       db.select(collection_ed, map,1).then(res => {
           resolve(res);
       }).catch((code, msg) => {
           reject("服务器开小差啦");
       });
...
const delAll = (_openid) => {
    return new Promise((resolve, reject) => {
        db.del(collection_ing, _openid).then(res => {
            resolve(res);
        }).catch((code, msg) => {
            reject("删除失败");
        });
...
const del = (_openid, _apply_info, data) => {
   ...
   //删除后更新
   return new Promise((resolve, reject) => {
      update(_openid, data, collection_ing).then(res => {
          resolve(res);
      }).catch((code, msg) => {
          reject("更新失败");
      });
...
const pass = (_openid, _apply_info, data_ing, data_ed) => {
   ...
   return new Promise((reslove, reject) => {    
      update(_openid, data_ing, collection_ing).then(res => {
         //删除申请中数据，del函数自带更新表
         del(_openid, data_ed, collection_ed).then(res => {
            reslove(res);
         }).catch((code, msg) => {
            reject("服务器开小差啦");
         })
...
const update = (_openid, data, collection) => {
    return new Promise((resolve, reject) => {
        db.update(collection, _openid, data).then(res => {
            resolve(res);
        }).catch((code, msg) => {
            reject("服务器开小差啦");
        });
