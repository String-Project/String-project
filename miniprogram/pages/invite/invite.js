...
Page({
  ...
  receive: function () {
    if (this.data.userInfo) {
      ...
      User.myPartner(this.data.userInfo._openid)
        .then((res) => {
          if (res == null) {
            Partner.bind(this.data.userInfo._openid, this.data.user_id)
              .then((res) => {
